...
class Commands {
  ...
  Future<String> getResult(String method, String target, String section, String field) async {
    return (await this.processTarget(method, target, section, field))["value"].toString();
  }
}
