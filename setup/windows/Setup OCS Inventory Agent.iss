...
#define AgentPath "path_of_your_agent\OCSInventory-Agent"
...
OutputBaseFilename=OCSInventory-Agent
...
[Files]
Source: "{#AgentPath}\setup\windows\{#AppExeName}"; DestDir: "{app}"; Flags: ignoreversion
