...
SHORT_OPTS="SU:u:p:m:l:c:snh"
LONG_OPTS="silent,url:,username:,password:,mode:,log-level:,log-file,log-file-path:,certificate:,bypass-certificate,service,now,help"
